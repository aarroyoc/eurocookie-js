...
t["sk"]=new Array;
t["sk"].push("K personalizácii obsahu a reklám, poskytovaniu funkcií sociálních médií a analýze našej návštevnosti využíváme súbory cookie. Informácie o tom, ako náš web používate, zdieľame so svojími partnermi pôsobiacimi v oblasti sociálnych médií, inzercie a analýz.");
t["sk"].push("OK");
t["sk"].push("Zobraziť podrobnosti");
t["sv"]=new Array;
